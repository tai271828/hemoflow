...
def calculateScaleAndShift(mesh, targetElements):
    ...
    # if LHS > RHS:
    #     print(f"NOTE!! Truncation bug detected: LHS {LHS} is larger than RHS {RHS}. It means potential truncation bug!!")
    #     print("Applying fix by adding 1 to the domain[1]")
    #     domain[1] += 1
    #     print(f"NOTE!! After fix, domain[1] is updated to {domain[1]}")
